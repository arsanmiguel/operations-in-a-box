...
This plugin provides datadog integration for the monitoring stack.
...
Edit `datadog-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for datadog metrics visualization.
...
## Support
- Configuration: Edit `datadog-config.yml`
