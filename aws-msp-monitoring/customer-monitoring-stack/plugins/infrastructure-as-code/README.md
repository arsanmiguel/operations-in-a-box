...
This plugin provides infrastructure-as-code integration for the monitoring stack.
...
# View metrics
curl http://localhost:9222/metrics
...
Edit `infrastructure-as-code-config.yml` for advanced configuration options.
...
```yaml
scrape_configs:
  - job_name: 'infrastructure-as-code'
    static_configs:
...
### Grafana Dashboard
Import dashboard for infrastructure-as-code metrics visualization.
...
# Check service logs
docker-compose logs infrastructure_as_code
...
## Support
- Configuration: Edit `infrastructure-as-code-config.yml`
