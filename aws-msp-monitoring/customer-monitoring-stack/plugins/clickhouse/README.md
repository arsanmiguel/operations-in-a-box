...
This plugin provides clickhouse integration for the monitoring stack.
...
Edit `clickhouse-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for clickhouse metrics visualization.
...
## Support
- Configuration: Edit `clickhouse-config.yml`
