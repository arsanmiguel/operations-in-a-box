...
This plugin provides business-intelligence integration for the monitoring stack.
...
curl http://localhost:9221/health
...
Edit `business-intelligence-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for business-intelligence metrics visualization.
...
# Check service logs
docker-compose logs business_intelligence
...
## Support
- Configuration: Edit `business-intelligence-config.yml`
