...
This plugin provides sumologic integration for the monitoring stack.
...
- `SERVICE_NAME`: sumologic
- `SERVICE_ENABLED`: true

### Service Configuration
Edit `sumologic-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for sumologic metrics visualization.
...
## Support
- Configuration: Edit `sumologic-config.yml`
