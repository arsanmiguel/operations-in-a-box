...
This plugin provides aws-config integration for the monitoring stack.
...
Edit `aws-config-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for aws-config metrics visualization.
...
# Check service logs
docker-compose logs aws_config
...
## Support
- Configuration: Edit `aws-config-config.yml`
