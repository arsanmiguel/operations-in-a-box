...
This plugin provides snowflake integration for the monitoring stack.
...
Edit `snowflake-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for snowflake metrics visualization.
...
## Support
- Configuration: Edit `snowflake-config.yml`
