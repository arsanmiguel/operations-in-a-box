...
This plugin provides okta integration for the monitoring stack.
...
Edit `okta-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for okta metrics visualization.
...
## Support
- Configuration: Edit `okta-config.yml`
