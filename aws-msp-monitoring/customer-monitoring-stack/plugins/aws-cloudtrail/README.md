...
This plugin provides aws-cloudtrail integration for the monitoring stack.
...
Edit `aws-cloudtrail-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for aws-cloudtrail metrics visualization.
...
# Check service logs
docker-compose logs aws_cloudtrail
...
## Support
- Configuration: Edit `aws-cloudtrail-config.yml`
