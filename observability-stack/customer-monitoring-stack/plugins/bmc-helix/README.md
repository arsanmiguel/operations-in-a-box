...
This plugin provides bmc-helix integration for the monitoring stack.
...
- `SERVICE_NAME`: bmc-helix
- `SERVICE_ENABLED`: true

### Service Configuration
Edit `bmc-helix-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for bmc-helix metrics visualization.
...
## Support
- Configuration: Edit `bmc-helix-config.yml`
