...
This plugin provides anomaly-detection integration for the monitoring stack.
...
Edit `anomaly-detection-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for anomaly-detection metrics visualization.
...
# Check service logs
docker-compose logs anomaly_detection
...
## Support
- Configuration: Edit `anomaly-detection-config.yml`
