...
This plugin provides redis integration for the monitoring stack.
...
Edit `redis-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for redis metrics visualization.
...
## Support
- Configuration: Edit `redis-config.yml`
