...
This plugin provides montycloud integration for the monitoring stack.
...
Edit `montycloud-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for montycloud metrics visualization.
...
# Check service logs
docker-compose logs montycloud
...
## Support
- Configuration: Edit `montycloud-config.yml`
