...
This repository provides a reference monitoring and observability stack for AWS MSPs, designed to demonstrate a practical baseline aligned with AWS MSP Program expectations. It is intended as a starting point—not an AWS fully managed or supported production solution.
