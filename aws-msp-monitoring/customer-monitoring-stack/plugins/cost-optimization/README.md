...
This plugin provides cost-optimization integration for the monitoring stack.
...
Edit `cost-optimization-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for cost-optimization metrics visualization.
...
# Check service logs
docker-compose logs cost_optimization
...
## Support
- Configuration: Edit `cost-optimization-config.yml`
