...
This plugin provides freshworks integration for the monitoring stack.
...
- `SERVICE_NAME`: freshworks
- `SERVICE_ENABLED`: true

### Service Configuration
Edit `freshworks-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for freshworks metrics visualization.
...
# Check service logs
docker-compose logs freshworks
...
## Support
- Configuration: Edit `freshworks-config.yml`
