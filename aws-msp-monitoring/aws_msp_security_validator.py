...
class SecurityValidator:
    ...
    def check_secure_credentials(self):
        ...
        if env_file.exists():
            ...
            if "change-me" not in content and "GRAFANA_ADMIN_PASSWORD=" in content:
                self.passed_checks.append("[OK] Secure credentials generated in .env")
                return True

        self.failed_checks.append("[FAIL] Missing or placeholder credentials in .env")
        return False
...
if __name__ == "__main__":
    ...
    parser.add_argument("--install-dir", default="customer-monitoring-stack", help="Installation directory to validate")
