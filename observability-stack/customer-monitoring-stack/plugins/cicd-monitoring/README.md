# Cicd Monitoring Plugin

This plugin provides cicd-monitoring integration for the monitoring stack.
...
- `SERVICE_NAME`: cicd-monitoring
- `SERVICE_ENABLED`: true

### Service Configuration
Edit `cicd-monitoring-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for cicd-monitoring metrics visualization.
...
# Check service logs
docker-compose logs cicd_monitoring
...
## Support
- Configuration: Edit `cicd-monitoring-config.yml`
