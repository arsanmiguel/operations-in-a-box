...
This plugin provides cert-auth integration for the monitoring stack.
...
curl http://localhost:9209/health
...
- `SERVICE_NAME`: cert-auth
- `SERVICE_ENABLED`: true

### Service Configuration
Edit `cert-auth-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for cert-auth metrics visualization.
...
## Support
- Configuration: Edit `cert-auth-config.yml`
