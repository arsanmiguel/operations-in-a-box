...
This plugin provides confluent integration for the monitoring stack.
...
Edit `confluent-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for confluent metrics visualization.
...
## Support
- Configuration: Edit `confluent-config.yml`
