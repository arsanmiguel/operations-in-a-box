...
This plugin provides aws-support integration for the monitoring stack.
...
Edit `aws-support-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for aws-support metrics visualization.
...
# Check service logs
docker-compose logs aws_support
...
## Support
- Configuration: Edit `aws-support-config.yml`
