...
This plugin provides aws-cloudformation integration for the monitoring stack.
...
curl http://localhost:9218/health

# View metrics
curl http://localhost:9218/metrics
...
Edit `aws-cloudformation-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for aws-cloudformation metrics visualization.
...
# Check service logs
docker-compose logs aws_cloudformation
...
## Support
- Configuration: Edit `aws-cloudformation-config.yml`
