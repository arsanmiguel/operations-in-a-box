...
This plugin provides aws-cloudwatch integration for the monitoring stack.
...
Edit `aws-cloudwatch-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for aws-cloudwatch metrics visualization.
...
# Check service logs
docker-compose logs aws_cloudwatch
...
## Support
- Configuration: Edit `aws-cloudwatch-config.yml`
