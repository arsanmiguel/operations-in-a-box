...
This plugin provides alertlogic integration for the monitoring stack.
...
- `SERVICE_NAME`: alertlogic
- `SERVICE_ENABLED`: true

### Service Configuration
Edit `alertlogic-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for alertlogic metrics visualization.
...
# Check service logs
docker-compose logs alertlogic
...
## Support
- Configuration: Edit `alertlogic-config.yml`
