...
This plugin provides zendesk integration for the monitoring stack.
...
Edit `zendesk-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for zendesk metrics visualization.
...
## Support
- Configuration: Edit `zendesk-config.yml`
