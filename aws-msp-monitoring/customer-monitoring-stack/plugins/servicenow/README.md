...
This plugin provides servicenow integration for the monitoring stack.
...
Edit `servicenow-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for servicenow metrics visualization.
...
# Check service logs
docker-compose logs servicenow
...
## Support
- Configuration: Edit `servicenow-config.yml`
