...
This plugin provides elasticsearch integration for the monitoring stack.
...
Edit `elasticsearch-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for elasticsearch metrics visualization.
...
## Support
- Configuration: Edit `elasticsearch-config.yml`
