...
This plugin provides network-security integration for the monitoring stack.
...
Edit `network-security-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for network-security metrics visualization.
...
# Check service logs
docker-compose logs network_security
...
## Support
- Configuration: Edit `network-security-config.yml`
