# Log Aggregation Plugin

This plugin provides log-aggregation integration for the monitoring stack.
...
- `SERVICE_NAME`: log-aggregation
- `SERVICE_ENABLED`: true

### Service Configuration
Edit `log-aggregation-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for log-aggregation metrics visualization.
...
# Check service logs
docker-compose logs log_aggregation
...
## Support
- Configuration: Edit `log-aggregation-config.yml`
