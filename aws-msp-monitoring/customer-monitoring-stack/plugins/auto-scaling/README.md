...
This plugin provides auto-scaling integration for the monitoring stack.
...
Edit `auto-scaling-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for auto-scaling metrics visualization.
...
# Check service logs
docker-compose logs auto_scaling
...
## Support
- Configuration: Edit `auto-scaling-config.yml`
