...
This plugin provides auto-remediation integration for the monitoring stack.
...
Edit `auto-remediation-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for auto-remediation metrics visualization.
...
# Check service logs
docker-compose logs auto_remediation
...
## Support
- Configuration: Edit `auto-remediation-config.yml`
