...
This plugin provides databricks integration for the monitoring stack.
...
Edit `databricks-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for databricks metrics visualization.
...
# Check service logs
docker-compose logs databricks
...
## Support
- Configuration: Edit `databricks-config.yml`
