...
This plugin provides terraform integration for the monitoring stack.
...
Edit `terraform-config.yml` for advanced configuration options.
...
### Grafana Dashboard
Import dashboard for terraform metrics visualization.
...
## Support
- Configuration: Edit `terraform-config.yml`
